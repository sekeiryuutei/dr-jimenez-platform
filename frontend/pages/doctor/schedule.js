                      ...
                      {rescheduling === a.id ? (
                        ...
                        <>
                          <div>
                            ...
                            <div className="panel-row-meta">{a.appointment_date?.slice(0, 10)} · {a.start_time?.slice(0, 5)} · {a.duration_minutes || 20} min · {a.status}</div>
                          </div>
                          <div className="panel-row-actions">
                            ...
                            <button className="panel-btn" onClick={() => updateStatus(a.id, 'completed', a.payment_status === 'paid')}>Completar</button>
